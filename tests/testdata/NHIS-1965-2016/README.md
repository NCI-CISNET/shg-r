...
The **trimmed csv-partial** tables that mirror the installed package layout live under `inst/extdata/2018/` (default) and, while it exists, `inst/extdata/2016/`. Regenerate them from this tree’s `csv-complete/` with:
