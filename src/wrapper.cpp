...
Rcpp::DataFrame SHGInterface::runSim(int repeat, short wRace, short wSex, short wYearBirth) {
   ...
   void SHGInterface::RunWebVersion(const char *sInputFileName)
   {
...
//' @field new Constructor
   class_<SHGInterface>("SHGInterface")
       ...
       .method("RunWebVersion", &SHGInterface::RunWebVersion, "Runs a simulation from a configuration file to produce results for a website (legacy)");
